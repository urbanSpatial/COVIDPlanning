...
<h1 style="font-size:28px;"><strong><center>CV-19 Grantmaking strategic planning analytics (Phase 1)</center></strong></h1>
<h2><i>An atlas of COVID-19 era need and philanthropic response in the Delaware Valley Region</i></h2>
<br>
<h4>June, 2020</h4>
<br>
<p style="font-size:18px;">Project Info - Where have Delaware Valley philanthropies allocated emergency COVID-19 resources, and how do those resources align with need? In this, the first Phase of a larger project, a series of strategic planning analytics have been designed to help stakeholders target future grantmaking where it is most in need.</p>
<br>
...
h3("Strategic planning overlay map")
br()
p("The goal of the map below is to help stakeholders target future grantmaking. Darker shades of blue show Census tracts where there is more relative need, here defined by a Social Vulnerability index, than relative grantmaking. Stakeholders may wish to invest more in these places. Shades of white indicate alignment between relative need and grantmaking. Darker shades of red are places where grantmaking is in relative excess.")
br()
...
leaflet(height = 550, width = 800) %>%
  ...
  addPolygons(data = county_vulnerability_grants,
              ...
              popup = ~paste0(County,"<br>",
                    ...
                    "Alignment: ", alignment),
              group = "Vulnerability") %>%
  # addPolygons(data = Region_county_outline_sf,
  #             fillOpacity = 0,
  #             stroke = TRUE,
  #             color = "black",
  #             opacity = 1,
